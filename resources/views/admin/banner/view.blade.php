                        ...
                        <table class="table datatable table_font_14 table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($item->photo))
                                        <img src="{{ env('IMAGE_SHOW_PATH').'banner/'.$item->photo }}" alt="Banner" width="50px" height="50px">
                                        @else
                                        <img src="{{ env('IMAGE_SHOW_PATH').'default/banner.png' }}" alt="Banner" width="50px" height="50px">
                                        @endif
                                    </td>
                                    <td>{{ $item->title ?? '' }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <a href="{{ url('admin/edit_banner') }}/{{ $item->id }}">
...
<div class="modal fade" id="status_modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/change_banner_status') }}" method="POST">
                @csrf
                <div class="modal-body">
