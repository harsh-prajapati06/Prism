                    ...
                    <div class="card-body">
                        <table class="table datatable table_font_14 table-responsive">
                            ...
                            <tbody>
                                ...
                                @php
                                $role_name = getRoleName($item->role_id ?? null);
                                @endphp
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>
                                        @if(!empty($item->photo))
                                        <img src="{{ env('IMAGE_SHOW_PATH').'profile/'.$item->photo }}" alt="Profile" class="rounded-circle" width="50px" height="50px">
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <a href="{{ url('admin/edit_user') }}/{{ $item->id }}">
...
<div class="modal fade" id="status_modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/change_user_status') }}" method="POST">
                @csrf
                <div class="modal-body">
